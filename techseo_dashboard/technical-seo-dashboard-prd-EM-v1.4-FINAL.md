...
**Company Website:** https://www.earnedmedia.com.au/
...
Earned Media, an award-winning Australian SEO agency, is losing valuable time and resources to manual SEO report creation. Account Managers spend an estimated **2-3 hours per client per month** compiling, formatting, and explaining reports, costing the agency approximately **100-150 hours/month**. This prevents them from focusing on high-value strategic consulting, impacting revenue and client satisfaction.
...
Earned Media needs to eliminate the manual effort required to deliver and explain technical SEO audit results to clients, freeing up Account Managers to focus on strategic consulting and improving client satisfaction.
...
- **Primary:** Earned Media's clients who need easy-to-understand, actionable insights into their website's SEO performance
- **Secondary:** Earned Media Account Managers who need to efficiently deliver and explain technical SEO findings, and want to focus on higher-value activities
...
### Primary Goal
Create a client-facing web dashboard that integrates existing Python SEO audit scripts with a professional, card-based UI, enabling client-specific audit views with Earned Media branding, targeting a **50% reduction in Account Manager time spent on reporting**.
...
- Present a professional, branded experience matching Earned Media's visual identity
...
4. Schedules 30-min call with Earned Media to ask questions
...
### Persona 3: Emily Torres - Earned Media Account Manager
**Role:** Senior Account Manager at Earned Media
...
**As an Earned Media Account Manager,** I want to initiate an SEO audit for a client with a single click so that I can quickly get up-to-date analysis of their website's performance and identify areas for improvement.
...
- [ ] Earned Media branding (logo, colors) is visible
...
**As an Earned Media Account Manager,** I want to quickly onboard a new client to the dashboard so that I can immediately start tracking their SEO performance.
...
- Status badge: Critical (#EA401D), Warning (#FD9C2C), Good (#22988D)
...
- "Coming Soon" badge in gray (#6B7280)
...
- **Script timeout:** "The audit took too long. Please try again or contact support@earnedmedia.com.au."
...
### 7.4 Branding
- **Primary CTA:** #EA401D (Orange/Red)
- **Header/Footer:** #031C38 (Dark Navy)
- **Secondary Accent:** #009BD8 (Cyan Blue)
- **Good Status:** #22988D (Teal)
- **Warning Status:** #FD9C2C (Gold/Amber)
- **Critical Status:** #EA401D (Orange/Red)
- **Coming Soon:** #6B7280 (Gray)
- **Light Backgrounds:** #F4F4F4, #DEE8F4
- **Font:** Inter
- **Logo:** Official Earned Media logo in header
...
### In Scope (MVP)
- Next.js dashboard with Earned Media branding
...
| Earned Media logo (high-res) | Marketing | Required | Text logo placeholder |
...
### A. Earned Media Brand Guidelines
| Element | Value |
|---------|-------|
| Primary CTA | #EA401D |
| Header/Footer | #031C38 |
| Secondary Accent | #009BD8 |
| Good Status | #22988D |
| Warning | #FD9C2C |
| Critical | #EA401D |
| Coming Soon | #6B7280 |
...
| Font | Inter |
| Website | earnedmedia.com.au |

### B. SEO It Is Feature Reference (27 Checks)
...
|----------|--------|-----------|
| Frontend hosting | Vercel | Native Next.js support, Sydney region, easy deployment |
...
**Deliverable:** Working Next.js app with Earned Media branding

**Tasks:**
- [ ] Initialize Next.js 15 project with TypeScript
- [ ] Configure Tailwind CSS with Earned Media brand colors
...
**Acceptance Criteria:**
- Landing page displays at `/` with Earned Media branding
...
| Item | Owner | Status |
|------|-------|--------|
| Earned Media logo (PNG, high-res) | Marketing | Required |
| Brand color approval | Marketing | Required |
...
| Document | Location |
|----------|----------|
| Product Requirements (this document) | `technical-seo-dashboard-prd-v1.4-FINAL.md` |
| Technical Specification | `technical-seo-dashboard-tech-spec-v1.2-FINAL.md` |
| Earned Media Logo | `EM_Logo.png` |
...
- [ ] All 27 SEO tools from SEO It Is reference
- [ ] White-label option for partner agencies
- [ ] API access for client integrations

---

**End of PRD v1.5 (FINAL - WITH IMPLEMENTATION GUIDE)**
